...
st.write("The location of popular tourist attractions in Malaysia has listed below:")
st.write("1. Petronas Twin Towers")
st.write("2. Batu Caves")
st.write("3. Mount Kinabalu")
st.write("4. George Town")
st.write("5. Langkawi Sky Bridge")
